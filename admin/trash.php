...
include('check.php');
$user=$_SESSION['admin'];
$rsql="SELECT * FROM report WHERE trash=1";
...
<head>
    ...
    <title>Trash Report</title>
</head>
<body>
<br><br>
<div class='container'>
<div class="row">
<div class="col-lg-10"><h3 class='text-success'>TRASHED REPORTS</h3></div>
<div class="col-lg-2"><h6 class='text-dark'><i class='fa fa-bell'></i> <?php echo($rcount); ?> UNREAD</h3></div>
</div>
<br>
<?php
$sql="SELECT * FROM report WHERE trash=1 ORDER BY id DESC";
$query=$dbcon->query($sql);
$count=$query->num_rows;
if($count < 1)
{
echo "<h2 class='text-center'>NO REPORT TIP HAS BEEN TRASHED YET</h2>";
} 
else
{
