...
$user=$_SESSION['admin'];
$rsql="SELECT * FROM report WHERE trash=0";
...
<div class='container'>
<div class="row">
<div class="col-lg-10"><h3 class='text-success'>ALL REPORTS</h3></div>
<div class="col-lg-2"><h6 class='text-dark'><i class='fa fa-bell'></i> <?php echo($rcount); ?> REPORTS</h3></div>
</div>
<br>
<?php
$sql="SELECT * FROM report WHERE trash=0 ORDER BY id DESC";
